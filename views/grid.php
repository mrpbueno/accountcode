...
<table id="pinpass"
       data-url="ajax.php?module=accountcode&command=getJSON&jdata=grid"
       data-cache="false"
	...
	<thead>
		<tr>
            <th data-field="name" class="col-md-9"><?php echo _("Name")?></th>
            <th data-field="pin" class="col-md-1 text-center"><?php echo _("Code")?></th>
